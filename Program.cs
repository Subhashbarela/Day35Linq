  ...
  public class Program
    {
        static void Main(string[] args)
        {
            ...
            List<ProductReview> productReviews = new List<ProductReview>()
            {
                ...
                new ProductReview() {ProductId =2, UserId=4, Rating=4, Review= "Good", isLike=true},
                ...
                new ProductReview() {ProductId =5, UserId=10, Rating=2, Review= "Bad", isLike=false},
           ...
           // management.SelectRecordList(productReviews);
            management.RetriveCountOfRecordList(productReviews);
